...
export default function Advanced() {
  return (
    <>
      <section className="bg-gray-100 py-32 pb-10 lg:pb-40">
          <div className="max-width">
          <h2 className="text-4xl font-bold text-slate-800 mb-3 text-center">Advanced Statistics</h2>
          <p className="text-slate-400 text-center mb-10 lg:mb-20">  Track how your links are performing across the web <br /> with our 
  ...
  mean a thing. Branded links help instil confidence in your content.</p>
       ...
       <article className="bg-white p-5 rounded relative">
           ...
           <p className="text-slate-400 text-sm">Gain insights into who is clicking your links. Knowing when and where 
